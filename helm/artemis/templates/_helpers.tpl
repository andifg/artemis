...
{{- define "artemis.frontend.name" -}}frontend{{- end }}

{{- define "artemis.backend.name" -}}backend{{- end }}
...
{{ include "artemis.backend.selectorLabels" . }}
{{- if .Chart.AppVersion }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
{{- end }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
...
{{- define "artemis.backend.selectorLabels" -}}
app.kubernetes.io/name: {{ include "artemis.backend.name" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end }}
